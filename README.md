...
**20 Jul 2017**: 1. Fork from raulmur/ORB_SLAM2. 2. modify with poine/ORB_SLAM2 commit to support the binary Vocabulary. 3. modify the save path of KeyFrameTrajectory.txt into the dataset folder.
